    ...
    scheduleNotification(time) {
        const localNotification = {
            ...
            android: // (optional) (object) — notification configuration specific to Android.
            {
              ...
              vibrate: [200,0,0,200,200,200] // (optional) (boolean or array) — if true, vibrate the device. An array can be supplied to specify the vibration pattern, e.g. - [ 0, 500 ].
